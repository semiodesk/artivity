(function () {
    ...
    KeyboardInputHandlerDirectiveController.$inject = ['$scope', 'api', 'hotkeys', 'windowService', 'navigationService', 'syncService'];

    function KeyboardInputHandlerDirectiveController($scope, api, hotkeys, windowService, navigationService, syncService) {
