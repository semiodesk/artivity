(function () {
    ...
    StartController.$inject = ['$scope', '$location', '$http', 'api', 'appService', 'agentService', 'windowService'];

    function StartController($scope, $location, $http, api, appService, agentService, windowService) {
        var t = this;
