(function () {
    angular.module('explorerApp').directive('artSettingsAccounts', AccountsSettingsDirective);
    ...
    angular.module('explorerApp').controller('AccountsSettingsDirectiveFormController', AccountsSettingsDirectiveFormController);
