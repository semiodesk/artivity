...
## Debug_Linux_dynamic
ProjectName            :=Client
ConfigurationName      :=Debug_Linux_dynamic
WorkspacePath          := "/home/meberl/Project/artivity/Artivity.Api.Client"
ProjectPath            := "/home/meberl/Project/artivity/Artivity.Api.Client/Client"
...
User                   :=Moritz Eberl
Date                   :=13/08/15
CodeLitePath           :="/home/meberl/.codelite"
...
SourceSwitch           :=-c 
OutputFile             :=$(IntermediateDirectory)/libartivity.so
Preprocessors          :=
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
$(OutputFile): $(IntermediateDirectory)/.d $(Objects) 
	...
	@$(MakeDirCommand) "/home/meberl/Project/artivity/Artivity.Api.Client/.build-debug"
	@echo rebuilt > "/home/meberl/Project/artivity/Artivity.Api.Client/.build-debug/Client"
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/meberl/Project/artivity/Artivity.Api.Client/Client/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Resource.cpp$(ObjectSuffix): Resource.cpp $(IntermediateDirectory)/Resource.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/meberl/Project/artivity/Artivity.Api.Client/Client/Resource.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Resource.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ActivityLog.cpp$(ObjectSuffix): ActivityLog.cpp $(IntermediateDirectory)/ActivityLog.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/meberl/Project/artivity/Artivity.Api.Client/Client/ActivityLog.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ActivityLog.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Activity.cpp$(ObjectSuffix): Activity.cpp $(IntermediateDirectory)/Activity.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/meberl/Project/artivity/Artivity.Api.Client/Client/Activity.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Activity.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Serializer.cpp$(ObjectSuffix): Serializer.cpp $(IntermediateDirectory)/Serializer.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/meberl/Project/artivity/Artivity.Api.Client/Client/Serializer.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Serializer.cpp$(ObjectSuffix) $(IncludePath)
