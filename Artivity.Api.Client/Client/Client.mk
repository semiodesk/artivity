...
WorkspacePath          := "D:\Projects\Artivitiy\Artivity.Api.Client"
ProjectPath            := "D:\Projects\Artivitiy\Artivity.Api.Client\Client"
...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)libcurl/include 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)curl-4 
ArLibs                 :=  "curl-4" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)libcurl 
...
$(IntermediateDirectory)/main.cpp$(ObjectSuffix): main.cpp $(IntermediateDirectory)/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/Projects/Artivitiy/Artivity.Api.Client/Client/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Resource.cpp$(ObjectSuffix): Resource.cpp $(IntermediateDirectory)/Resource.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/Projects/Artivitiy/Artivity.Api.Client/Client/Resource.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Resource.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ActivityLog.cpp$(ObjectSuffix): ActivityLog.cpp $(IntermediateDirectory)/ActivityLog.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/Projects/Artivitiy/Artivity.Api.Client/Client/ActivityLog.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ActivityLog.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Activity.cpp$(ObjectSuffix): Activity.cpp $(IntermediateDirectory)/Activity.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/Projects/Artivitiy/Artivity.Api.Client/Client/Activity.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Activity.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Serializer.cpp$(ObjectSuffix): Serializer.cpp $(IntermediateDirectory)/Serializer.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/Projects/Artivitiy/Artivity.Api.Client/Client/Serializer.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Serializer.cpp$(ObjectSuffix) $(IncludePath)
